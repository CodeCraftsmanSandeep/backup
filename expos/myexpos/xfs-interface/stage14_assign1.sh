...
load --module 7 $HOME/oslab/stage14/assign1/boot.xsm
load --module 5 $HOME/oslab/stage14/scheduler.xsm
load --init $HOME/oslab/stage13/assign1/odd.xsm
...
load --exec $HOME/oslab/stage13/assign1/even.xsm
load --exec $HOME/oslab/stage14/assign1/prime.xsm
